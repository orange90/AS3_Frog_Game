package  {
	...
	public class MC5 extends MovieClip {
		...
		public function MC5() {
			levelRecorder.level = 5;//把当前关卡数记录到levelRecorder里
			...
			frog1.addNearby(frog7);
			
			frog2.addNearby(frog1);
			frog2.addNearby(frog3);
			frog2.addNearby(frog7);
			...
			frog7.addNearby(frog1);
			frog7.addNearby(frog2);
